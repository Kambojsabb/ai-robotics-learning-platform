...
const port=process.env.PORT||5000;connectDB().then(()=>app.listen(port,()=>console.log(`API listening on ${port}`))).catch(e=>{console.error('DB connection failed',e);process.exit(1)});
